package com.tiantian.distribute.common.main;

import com.tiantian.distribute.common.config.ApplicationConfig;
import com.tiantian.distribute.common.config.SpringJavaConfiguration;
...
public class Main {
	public static void main(String[] args) throws Exception {
		ApplicationConfig applicationConfig = new ApplicationConfig("com.tiantian.distribute.common.action");
